...
class Routes(
  ...
  // @LINE:7
  IndexController_1: controllers.IndexController,
  // @LINE:10
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:10
    Assets_0: controllers.Assets
  ) = this(errorHandler, IndexController_1, Assets_0, "/")

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, IndexController_1, Assets_0, prefix)
  }
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_IndexController_index0_route(params@_) =>
      call { 
        controllers_IndexController_index0_invoker.call(IndexController_1.index)
      }
